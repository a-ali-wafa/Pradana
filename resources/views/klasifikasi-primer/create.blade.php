...
@section('title', 'Tambah Klasifikasi Primer - PRADANA')
...
<div class="row justify-content-center">
    <div class="col-lg-6">
        ...
        <div class="card">
            <div class="card-header"><i class="fas fa-plus me-2 text-primary"></i>Tambah Klasifikasi Primer</div>
            <div class="card-body">
                <form method="POST" action="{{ route('klasifikasi-primer.store') }}">
                    @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode" class="form-control font-monospace @error('kode') is-invalid @enderror"
                               value="{{ old('kode') }}" placeholder="Contoh: 01" required>
                        @error('kode') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        <div class="form-text">Kode harus unik. Contoh: 01, 02, 03 dst.</div>
                    </div>
                    <div class="mb-4">
                        <label class="form-label small fw-bold">Nama <span class="text-danger">*</span></label>
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                               value="{{ old('nama') }}" placeholder="Nama klasifikasi primer" required>
